...
import com.sdd.sddpartner.service.PdsService;
...
public class PdsController {
	...
	@PreAuthorize("hasRole('ADMIN')")
	@PutMapping("/{itemId}")
	public ResponseEntity<Pds> modify(@PathVariable("itemId") Long itemId, @Validated @RequestBody Pds pds) throws Exception {
